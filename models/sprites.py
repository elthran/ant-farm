...
class Sprite(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self._x_pos = random.randint(200, Graphics.SCREEN_WIDTH - 200)
        self._y_pos = random.randint(200, Graphics.SCREEN_HEIGHT - 200)
    ...
    def x_pos(self, x_pos):
        if x_pos > Graphics.SCREEN_WIDTH:
            x_pos = Graphics.SCREEN_WIDTH
        elif x_pos < 0:
            x_pos = 0
        self._x_pos = x_pos
    ...
    def y_pos(self, y_pos):
        if y_pos > Graphics.SCREEN_HEIGHT:
            y_pos = Graphics.SCREEN_HEIGHT
        elif y_pos < 0:
            y_pos = 0
        self._y_pos = y_pos

    def update(self):
        """By default, all objects with speed should turn to face their direction"""
        if self.speed != 0:
